...
// PC-lint (TM)
//------------------------------------------------------------------------
The project has been set up with an additional PC-lint (TM) target.
PC-lint (TM) is a product from Gimpel Software and is sold separately
(see www.gimpel.com)
In order to use PC-lint (TM), you need:
- The PC-lint (TM) from Gimpel Software installed in the 'lint' subfolder of
  your installation
- A license for the CodeWarrior PC-lint (TM) plugin. Such a license comes
  with the professional edition of CodeWarrior.
